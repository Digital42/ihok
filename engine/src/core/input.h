...
// this macro and the subsequent enum are for mapping keyboard inputs ot
...
typedef enum keys {
    ...
    DEFINE_KEY(SPLASH, 0xBF),
    DEFINE_KEY(GRAVE, 0xC0),

    KEYS_MAX_KEYS
} keys;

//standard initialize and shutodwn functions for each "module"
void input_initialize();
void input_shutdown();
//obviously updates to catch key/button presses
...
void input_process_key(keys, b8 pressed);
...
KAPI b8 input_was_button_down(buttons buttony);
